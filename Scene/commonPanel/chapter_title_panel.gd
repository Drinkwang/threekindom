...
const OPEN_SOUND: AudioStream = preload("res://Asset/sound/fade_2.mp3")
...
func play() -> void:
	...
	fade_out.parallel().tween_property(_root, "position:y", -10.0, fade_time)
...
func _play_open_sound() -> void:
	if OPEN_SOUND != null:
		SoundManager.play_sound(OPEN_SOUND)
