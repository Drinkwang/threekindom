...
var policy_Item=[
	...
	
	{
		...
		"index":1,
		"name":"上策-德政宽徭",
		"detail":"以仁德施政，减少徭役与兵员，恢复民众信任，该政策需要支付500民力实施", #每天获取钱下降，任务凑钱正常
		"tootip":"支付500民力恢复{point1}民心",
		"group":3
	},
	{
		#根据豪族派系人数进行增强
		...
		"index":2,
		"name":"中策-仁心济民",
		"detail":"施行赈济政策，通过钱的直接援助，恢复民众信任，该政策需要支付1000钱实施", #前往花园并通向小道，ps_任务凑齐的钱会少
		"tootip":"支付1000钱恢复{point2}民心",
		"group":3
	},
	{
		#根据丹阳派派系人数进行增强
		...
		"index":3,
		"name":"下策-戍卒强征",#戍卒强征
		"detail":"强化征集制度，严格实施民力和财富的强制征集。该政策需要20点民心实施", #前往花园并通向小道#，每天获取钱上升，任务凑钱多
		"tootip":"损耗20民心，获得{point3}钱、{point4}民力",
		"group":3
	},	
]
enum policyID{
