...
var policy_Item=[
	...
	#主线第一个计策
	{
		...
		"index":1,
		"name":"上策-以商代赈",
		"detail":"将给与商人更多指示性目标,用行政命令迫使商业协助完成粮食问题，军队好感上升，但商业具有不稳定性，获得一笔不定额的钱", #每天获取钱下降，任务凑钱正常
		"group":1
	},
	{
		"id":5,
	...
	
	{
		...
		"tootip":"该政策会让士族派好感上升10，豪族派好感下降5，徐州百姓的民心上升5，每旬获取金额+10，追查内应进度+2",
		"group":2
	},
	{
		"id":8,
		...
		"tootip":"该政策会让士族派好感上升5，豪族派好感上升5，每旬获取金额+10，每旬获得民力+5，获得益气丸x2",
		"group":2
	},
	{
		"id":9,
		...
		"tootip":"该政策会让士族派好感下降5，豪族派好感下降5，丹阳派好感下降5，每旬获取金额-5，每旬获取民力-5，钱+300,民力+150",
		"group":2
	},	
	...
	
	{
		...
		"index":1,
		"name":"上策-德政宽徭",
		"detail":"以仁德施政，减少徭役与兵员，恢复民众信任，需要支付{cost1}民力实施", #每天获取钱下降，任务凑钱正常
		"tootip":"支付{cost1}民力恢复{point1}民心",
		"group":3
	},
	{
		#根据豪族派系人数进行增强
		...
		"index":2,
		"name":"中策-仁心济民",
		"detail":"施行赈济政策，通过钱的直接援助，恢复民众信任，需要支付{cost2}钱实施", #前往花园并通向小道，ps_任务凑齐的钱会少
		"tootip":"支付{cost2}钱恢复{point2}民心",
		"group":3
	},
	{
		#根据丹阳派派系人数进行增强
		...
		"index":3,
		"name":"下策-戍卒强征",#戍卒强征
		"detail":"强化征集制度，严格实施民力和财富的强制征集，需要消耗{cost3}民心实施", #前往花园并通向小道#，每天获取钱上升，任务凑钱多
		"tootip":"损耗{cost3}民心，获得{point3}钱、{point4}民力",
		"group":3
	},	
]
enum policyID{
