...
func _initData():
	...
	elif GameManager.sav.have_event["陈登支线1"]==false and GameManager.sav.day>=5 and GameManager.sav.endPath==GameManager.endPath.none:
		chendeng.show()
		chendeng.showEX=true
	...
	elif GameManager.sav.have_event["陈登支线2"]==false and GameManager.sav.have_event["陈登支线1"]==true and GameManager.sav.chendenSideWait==0 and GameManager.sav.endPath==GameManager.endPath.none:
		chendeng.show()
		chendeng.showEX=true
